 ...
 * generated in the liang.ren.hello package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayBye_QNAME = new QName("hello.ren.liang", "sayBye");
    private final static QName _SayByeResponse_QNAME = new QName("hello.ren.liang", "sayByeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: liang.ren.hello
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "hello.ren.liang", name = "sayBye")
     ...
     * 
     */
    @XmlElementDecl(namespace = "hello.ren.liang", name = "sayByeResponse")
