 ...
 * 2014-05-13T11:40:58.252+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "HelloServiceService", 
                  wsdlLocation = "http://localhost:8080/cxf-web-server/service/hello?wsdl",
                  targetNamespace = "http://server.web.rl.com/") 
public class HelloServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.web.rl.com/", "HelloServiceService");
    public final static QName HelloServicePort = new QName("http://server.web.rl.com/", "HelloServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cxf-web-server/service/hello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cxf-web-server/service/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
