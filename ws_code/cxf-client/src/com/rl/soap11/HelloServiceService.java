 ...
 * 2014-05-13T10:47:27.402+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "HelloServiceService", 
                  wsdlLocation = "http://127.0.0.1:5555/hello?wsdl",
                  targetNamespace = "http://server.cxf.rl.com/") 
public class HelloServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.cxf.rl.com/", "HelloServiceService");
    public final static QName HelloServicePort = new QName("http://server.cxf.rl.com/", "HelloServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:5555/hello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:5555/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
